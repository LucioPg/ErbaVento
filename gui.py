...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_7.addWidget(self.bot_esporta)
        ...
        self.bot_aggiungiSpesa = QtWidgets.QPushButton(self.tab2)
        self.bot_aggiungiSpesa.setObjectName("bot_aggiungiSpesa")
        self.verticalLayout_15.addWidget(self.bot_aggiungiSpesa)
        self.bot_rimuoviSpesa = QtWidgets.QPushButton(self.tab2)
        self.bot_rimuoviSpesa.setObjectName("bot_rimuoviSpesa")
        self.verticalLayout_15.addWidget(self.bot_rimuoviSpesa)
        ...
        MainWindow.setTabOrder(self.bot_cancella, self.bot_prenota)
        MainWindow.setTabOrder(self.bot_prenota, self.tabWidget)
        MainWindow.setTabOrder(self.tabWidget, self.lineEdit_nome)
        MainWindow.setTabOrder(self.lineEdit_nome, self.lineEdit_cognome)
        MainWindow.setTabOrder(self.lineEdit_cognome, self.lineEdit_telefono)
        MainWindow.setTabOrder(self.lineEdit_telefono, self.lineEdit_email)
        MainWindow.setTabOrder(self.lineEdit_email, self.dateEdit_dal)
        MainWindow.setTabOrder(self.dateEdit_dal, self.dateEdit_al)
        MainWindow.setTabOrder(self.dateEdit_al, self.radio_colazione)
        MainWindow.setTabOrder(self.radio_colazione, self.bot_aggiungiSpesa)
        MainWindow.setTabOrder(self.bot_aggiungiSpesa, self.spinBox_importo)
        MainWindow.setTabOrder(self.spinBox_importo, self.spinBox_ospiti)
        MainWindow.setTabOrder(self.spinBox_ospiti, self.spinBox_bambini)
        MainWindow.setTabOrder(self.spinBox_bambini, self.plainTextEdit_note)
        MainWindow.setTabOrder(self.plainTextEdit_note, self.bot_salva)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Tasse finora"))
        item = self.tableWidget_stat.verticalHeaderItem(4)
        item.setText(_translate("MainWindow", "Numero Notti"))
        item = self.tableWidget_stat.verticalHeaderItem(5)
        item.setText(_translate("MainWindow", "Netto finora"))
        ...
        self.bot_aggiungiSpesa.setText(_translate("MainWindow", "aggiungi spesa"))
        self.bot_rimuoviSpesa.setText(_translate("MainWindow", "rimuovi spesa"))
