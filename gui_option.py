...
class Ui_Dialog_opt(object):
    def setupUi(self, Dialog_opt):
        ...
        self.spinbox_provvigione_2 = QtWidgets.QDoubleSpinBox(self.tab_struttura)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinbox_provvigione_2.sizePolicy().hasHeightForWidth())
        self.spinbox_provvigione_2.setSizePolicy(sizePolicy)
        self.spinbox_provvigione_2.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        self.spinbox_provvigione_2.setMinimum(0.0)
        self.spinbox_provvigione_2.setMaximum(100.0)
        self.spinbox_provvigione_2.setSingleStep(1.0)
        self.spinbox_provvigione_2.setProperty("value", 0.0)
        self.spinbox_provvigione_2.setObjectName("spinbox_provvigione_2")
        self.horizontalLayout_8.addWidget(self.spinbox_provvigione_2)
        ...
        self.horizontalLayout.addWidget(self.spinbox_provvigione)
    ...
    def retranslateUi(self, Dialog_opt):
        ...
        self.spinbox_provvigione_2.setSuffix(_translate("Dialog_opt", "%"))
        ...
        self.tableWidget__importi.setToolTip(
            _translate("Dialog_opt", "Doppio click su una riga per impostare il prezzo"))
